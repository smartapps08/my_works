...
public class CaldroidFragment extends DialogFragment {
	...
	private TextView monthTitleTextView, monthTitleTextViewBangla;
	...
	public void refreshView() {
		// Refresh title view
		int monthIndex = new DateTime(year, month, 1, 0, 0).getMonthOfYear();

		monthTitleTextView
				.setText(tfUtil
						.convertUnicode2BijoyString(BanglaDateHelper.months[monthIndex - 1])
						+ " " + tfUtil.convertUnicode2BijoyString("" + year));

		BanglaDateConverter conv = new BanglaDateConverter(1, month, year, 1);
		BanglaDate bDate = conv.calculateBanglaDate();
		if (month == 4) {
			monthTitleTextViewBangla
					.setText(tfUtil
							.convertUnicode2BijoyString(BanglaDateHelper.banglaMonthRange[monthIndex - 1])
							+ " "
							+ tfUtil.convertUnicode2BijoyString(""
									+ bDate.getBangYear() + "-"
									+ (bDate.getBangYear() + 1)));
		} else {
			monthTitleTextViewBangla
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		monthTitleTextView = (TextView) view
				.findViewById(R.id.calendar_month_year_textview_eng);
		monthTitleTextViewBangla = (TextView) view
				.findViewById(R.id.calendar_month_year_textview_bangla);
		tfUtil = new BijoyFontUtil();
		banglaTypeface = Typeface.createFromAsset(getActivity().getAssets(),
				"font/suttony.ttf");

		monthTitleTextView.setTypeface(banglaTypeface);
		monthTitleTextViewBangla.setTypeface(banglaTypeface);
